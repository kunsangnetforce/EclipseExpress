...
public class CategoryData {
    ...
    * */
    ...
    public CategoryData(String app_id, String app_name, String developer_name, String image_url, String price, String rating, String app_url, String category, boolean staticApp) {
        this.app_id = app_id;
