...
public class ManActivity extends AppCompatActivity implements ListView.OnItemClickListener
{

    //Root URL of our web service
    public static final String ROOT_URL = "http://odishatv.in/otv-app/write/";
    ...
    private void getBooks()
    {
        ...
        api.getBooks(new Callback<List<Book>>()
        {
            ...
            public void failure(RetrofitError error)
            {
                ...
                System.out.println("errordata==========="+ error.toString());
                loading.dismiss();
            }
        });
    }
    ...
    private void showList()
    {
        ...
        for(int i=0; i<books.size(); i++)
        {
            ...
            System.out.println("books ==========="+items[i].toString());

        }

        System.out.println("json data is getting==========="+ books.size());
